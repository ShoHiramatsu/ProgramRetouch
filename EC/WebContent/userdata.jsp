				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
							<%
										for (BuyDataBeans List : bdbList) {
									%>

								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?id=<%=List.getId()%>" class="btn-floating btn waves-effect waves-light"> <i class="material-icons">details</i></a></td>
									<td class="center"><%=List.getFormatDate()%></td>
									<td class="center"><%=List.getDeliveryMethodName()%></td>
									<td class="center"><%=List.getTotalPrice()%>円</td>
